...
import com.example.demo.security.MyBCryptPasswordEncoder;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    private static final String KEY = "localhost:8080";
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/static/css/**", "/js/**", "/static/fonts/**", "/index", "/favicon.ico","static/**").permitAll()
                .antMatchers("/h2-console/**").permitAll()
                .antMatchers("/login","/admin").permitAll()
              //  .antMatchers("/admin/**").hasRole("ADMIN")
                .and()
                .formLogin()   //基于 Form 表单登录验证4
                .loginPage("/login")
